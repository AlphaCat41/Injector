...
int wmain () {
	...
	exeName = L"SomeFunction.exe"; // Replace with the target process name
	dllPath = L"C:\\Users\\DELL\\Desktop\\cpp_repos\\Injector\\x64\\Debug\\SampleDLL.dll"; // Replace with the full path to your DLL
